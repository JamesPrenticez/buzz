...
export const ArrowExternalIcon = (props: SVGProps<SVGSVGElement>): ReactElement => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="50%" height="50%" viewBox="0 0 20 20" fill="currentColor" stroke="none" strokeWidth={1} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <g id="arrow-external" data-name="Group 11066" transform="translate(-86 -13)"><rect id="Rectangle_1839" data-name="Rectangle 1839" width="20" height="20" transform="translate(86 13)" fill="none"/><path id="ExternalLink_ActionBlue_Icon_80x80px" d="M10.018,11.66v1.318a.587.587,0,0,0,.565.565l10.541.027L9.561,25.186a.585.585,0,0,0,0,.807l.941.941a.585.585,0,0,0,.807,0L22.9,15.344V25.885a.587.587,0,0,0,.565.565l1.345.027a.587.587,0,0,0,.565-.565L25.4,11.66a.587.587,0,0,0-.565-.565H10.61A.558.558,0,0,0,10.018,11.66Z" transform="translate(78.6 3.906)" /></g>
